...
//    }
//
//    //Method to search vehicles by Models.Vehicle type, and return array list of all vehicles that match
...
//        if (isCarFound) {
//            DealershipFileManager.writeToInventory(inventory);
//            System.out.println("\nSuccess! Models.Vehicle was sold!");
...
//        if(isCarFound) {
//            DealershipFileManager.writeToInventory(inventory);
//            System.out.println("\nSuccess! Models.Vehicle was leased!");
